...
async function runStartupMigrations() {
  ...
  try {
    ...
    const defaultTemplates = [
      { key: 'WELCOME_TRIAL', name: 'Welcome Trial', subject: 'Welcome to {SoftwareName}!', message: 'Hi {Name}, your trial has started.', vars: '["Name", "SoftwareName"]' },
      { key: 'EXPIRY_REMINDER_DAILY', name: 'Expiry Reminder', subject: 'Your {SoftwareName} Plan is Expiring Soon', message: 'Hello {Name},\n\nYour current plan is expiring soon.\n\nSoftware: {SoftwareName}\nPlan: {PlanName}\nExpiry Date: {ExpiryDate}\nDays Left: {Days}\n\nPlease renew your plan to continue using the service without interruption:\nhttps://gym-newss.kiaantechnology.com/admin/subscription\n\nThank you,\nKiaan Technology Pvt Ltd', vars: '["Name", "SoftwareName", "PlanName", "Days", "ExpiryDate"]' },
      { key: 'TRIAL_EXPIRED_FINAL', name: 'Plan Expired', subject: 'Your {SoftwareName} Plan Has Expired', message: 'Hello {Name},\n\nYour {PlanName} plan for {SoftwareName} has expired on {ExpiryDate}.\n\nTo restore access to your account, features, and dashboard, please renew your subscription.\n\nRenewal Link:\nhttps://gym-newss.kiaantechnology.com/admin/subscription\n\nThank you,\nKiaan Technology Pvt Ltd', vars: '["Name", "SoftwareName", "PlanName", "ExpiryDate"]' },
      { key: 'SUBSCRIPTION_ACTIVATED', name: 'Subscription Activated', subject: 'Welcome to {SoftwareName} - Your Account is Ready', message: 'Hello {Name},\n\nWelcome to {SoftwareName}.\n\nYour account and plan subscription have been successfully activated.\n\nAccount Details:\nName: {Name}\nEmail / Login ID: {Email}\nPassword: {Password}\nSoftware: {SoftwareName}\n\nPlan Details:\nPlan: {PlanName}\nPrice: ₹{Amount}\nDuration: {Duration}\nStart Date: {StartDate}\nExpiry Date: {ExpiryDate}\n\nLogin Link:\n{LoginUrl}\n\nPlease keep your login credentials secure.\n\nThank you,\nKiaan Technology Pvt Ltd', vars: '["Name", "SoftwareName", "Email", "Password", "PlanName", "Amount", "Duration", "StartDate", "ExpiryDate", "LoginUrl"]' },
      { key: 'PLAN_PURCHASED', name: 'Plan Purchased', subject: 'Plan Purchased - {SoftwareName}', message: 'Hi {Name}, you purchased {PlanName}.', vars: '["Name", "PlanName", "SoftwareName"]' },
      ...
      { key: 'PLAN_UPGRADED', name: 'Plan Upgraded', subject: 'Plan Upgraded Successfully! - {SoftwareName}', message: 'Hello {Name},\n\nYour account plan has been successfully upgraded to {PlanName}.\n\nAccount Details:\nEmail / Login ID: {Email}\nPassword: {Password}\nSoftware: {SoftwareName}\n\nPlan Details:\nUpgraded Plan: {PlanName}\nAmount Paid: ₹{Amount}\n\nLogin Link:\n{LoginUrl}\n\nPlease keep your login credentials secure.\n\nThank you for choosing Kiaan Technology Pvt Ltd!', vars: '["Name", "PlanName", "Email", "Password", "Amount", "SoftwareName", "LoginUrl"]' },
    ...
    const templatesToForceUpdate = [
      'PLAN_UPGRADE_REQUEST', 'PLAN_PURCHASED', 'PLAN_UPGRADED', 'SUBSCRIPTION_ACTIVATED', 'EXPIRY_REMINDER_DAILY', 'TRIAL_EXPIRED_FINAL',
