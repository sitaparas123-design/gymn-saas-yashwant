...
async function runStartupMigrations() {
  ...
  try {
    ...
    const defaultTemplates = [
      ...
      { key: 'PLAN_UPGRADED', name: 'Plan Upgraded', subject: 'Plan Upgraded Successfully!', message: 'Hi {Name},\n\nYour account plan has been successfully upgraded to {PlanName}.\n\nAccount Email: {Email}\nAmount Paid: ₹{Amount}\n\nThank you for choosing Kiaan Technology Pvt Ltd!', vars: '["Name", "PlanName", "Email", "Amount"]' },
